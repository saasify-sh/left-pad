...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { LeftPadController } from './left-pad';
...
export function RegisterRoutes(router: KoaRouter) {
  ...
  router.get('/',
    async (context: any, next: any) => {
      const args = {
        string: { "in": "query", "name": "string", "required": true, "dataType": "string" },
        length: { "in": "query", "name": "length", "required": true, "dataType": "double" },
        pad: { "default": " ", "in": "query", "name": "pad", "dataType": "string" },
      };
      ...
      const controller = new LeftPadController();

      const promise = controller.leftPad.apply(controller, validatedArgs as any);
